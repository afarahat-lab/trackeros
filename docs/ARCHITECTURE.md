...
src/modules/status/    — Status module (health and version endpoints)
...
**IHealthService**
- Method: `getHealth(): Promise<HealthStatus>`
...
**IHealthRepository**
- Method: `checkDatabaseConnection(): Promise<boolean>`
...
- HealthService.getHealth() produces a COMPUTED HealthStatus on each invocation
