...
- `BalanceService` still carries its own private `addMonths` (3a deferred it to 3b; 3b only imported `periodContaining`, leaving the duplicate `addMonths` in place).
