...
## Design context
{
  "correlationId": "9522f994-2e69-4c8e-a7f2-5f6c7bbec2a3",
  "domainChanges": [],
  "apiContracts": [
    {
      "method": "GET",
...
I will create the two required files: src/app.ts for the Express application    
with the health check endpoint, and src/index.ts as the entry point to start the
server on port 3000.                                                            
...
Tokens: 1.4k sent, 140 received. Cost: $0.00030 message, $0.00030 session.
