...
```
## Task
Update the LeaveRequest model in src/modules/leave/leave.model.ts to include a 'reason' property of type string. This will ensure that the LeaveRequestRepository can handle leave requests correctly without TypeScript errors.
...
## Success criteria
- The LeaveRequest model includes a 'reason' property of type string without TypeScript errors.
...
## Design context
{
  "correlationId": "6f443e21-081b-4b74-ac8f-b0be70ae73e1",
  "domainChanges": [
    {
  ...
  "apiContracts": [
    {
      ...
      "description": "Creates a new leave request with a reason.",
      "requestBody": {
        "reason": "string"
      },
      "responseBody": {
    ...
    },
    {
      ...
      "description": "Updates an existing leave request with a reason.",
      "requestBody": {
        "reason": "string"
      },
      "responseBody": {
...
a reason property of type string, I will modify the existing model definition   
accordingly.                                                                    
...
Tokens: 1.7k sent, 140 received. Cost: $0.00035 message, $0.00035 session.
