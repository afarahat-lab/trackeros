...
- Any changes outside src/modules/leave/leave.model.ts and tests/unit/leave.model.test.ts
- Other modules or files not mentioned in the intent
...
## Design context
{
  "correlationId": "b94d8f42-c479-4e2a-b664-dd70a0e5fcd1",
  "domainChanges": [
    {
