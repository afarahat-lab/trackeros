...
## Success criteria
- LeaveRequest and CreateLeaveRequestDto are defined correctly in src/modules/leave/leave.model.ts and LeaveType is imported from src/shared/types/index.ts.
...
## Design context
{
  "correlationId": "52d5fcc9-c3e1-4edd-8287-d5adf78b2b22",
  "domainChanges": [
    {
...
Here is the implementation for the leave model as specified in your request.    
...
Tokens: 1.9k sent, 117 received. Cost: $0.00035 message, $0.00035 session.
