...
## Design context
{
  "correlationId": "1cc73ae1-4822-4e6e-b336-8fbbd541ed41",
  "domainChanges": [],
  "apiContracts": [
    {
      "method": "GET",
...
with the health check endpoint, and src/index.ts to start the server on port    
3000.                                                                           
...
Tokens: 1.4k sent, 134 received. Cost: $0.00029 message, $0.00029 session.
